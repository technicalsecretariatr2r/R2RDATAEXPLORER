...
st.markdown('<div style="text-align: justify;">R2R is a worldwide campaign launched in 2021 by the UN Climate Change High-Level Champions (HLCs). It aims to increase the resilience of four billion people living in vulnerable communities in collaboration with partner organizations from around the world, while developing tools to support them in their work. The campaign has developed a people-centred resilience Metrics Framework for non-State actors to report climate resilience actions and to quantify and validate their impact under a common framework. This framework will be open for public consultation at COP27.</div>', unsafe_allow_html=True)
